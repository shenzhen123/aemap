...
namespace AeMapz
{
    public partial class SymbolSelectorFrm : Form
    {
        ...
        /// <summary>
        /// 初始化SymbolControl的StyleClass,图层如果已有符号，则把符号添加到SymbologyControl中的第一个符号，并选中
        /// </summary>
        ...
        {
            //取得ArcGIS安装路径
            //string sInstall = ReadRegistry("D:\\Program Files (x86)\\ArcGIS\\Desktop10.2");
            ...
            this.axSymbologyControl.LoadStyleFile(Application.StartupPath+ "\\数据\\ESRI_Optimized.ServerStyle");
            ...
            switch (((IFeatureLayer)pLayer).FeatureClass.ShapeType)
            {
                ...
                case ESRI.ArcGIS.Geometry.esriGeometryType.esriGeometryPolyline:
                    ...
                    break;
                case ESRI.ArcGIS.Geometry.esriGeometryType.esriGeometryPolygon://几何多边形
                    ...
                    this.btnOutlineColor.Visible = true;
                    break;
                case ESRI.ArcGIS.Geometry.esriGeometryType.esriGeometryMultiPatch://几何多面体
                    this.SetFeatureClassStyle(esriSymbologyStyleClass.esriStyleClassFillSymbols);
                    this.lblAngle.Visible = false;
                    this.nudAngle.Visible = false;
                    this.lblSize.Visible = false;
        ...
        /// <returns></returns>
        public IColor ConvertColorToColor(Color color)
        {
        ...
        private void axSymbologyControl_OnItemSelected(object sender, ISymbologyControlEvents_OnItemSelectedEvent e)
        {
            ...
            switch (this.axSymbologyControl.StyleClass)
            {
                ...
                case esriSymbologyStyleClass.esriStyleClassMarkerSymbols:
                    ...
                    //线符号
                case esriSymbologyStyleClass.esriStyleClassLineSymbols:
                    color = this.ConvertIRgbColorToColor(((ILineSymbol)this.pStyleGalleryItem.Item).Color as IRgbColor);
                    //设置线宽初始值
        ...
        private void btnColor_Click(object sender, EventArgs e)
        {
            ...
            if(this.colorDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                switch (this.axSymbologyControl.StyleClass)
                {
                    //点符号
                    case esriSymbologyStyleClass.esriStyleClassMarkerSymbols:
                        ((IMarkerSymbol)this.pStyleGalleryItem.Item).Color = this.ConvertColorToColor(this.colorDialog.Color);
                        break;
                    //线符号
                    case esriSymbologyStyleClass.esriStyleClassLineSymbols:
                        ((ILineSymbol)this.pStyleGalleryItem.Item).Color = this.ConvertColorToColor(this.colorDialog.Color);
                        break;
                    //面符号
                    case esriSymbologyStyleClass.esriStyleClassFillSymbols:
                        ((IFillSymbol)this.pStyleGalleryItem.Item).Color = this.ConvertColorToColor(this.colorDialog.Color);
                        break;
                }
                //更新符号预览
                this.PreviewImage();
        ...
        private void btnMoreSymbols_Click(object sender, EventArgs e)
        {
            ...
            {
                //string sInstall = ReadRegistry("SOFTWARE\\ESRI\\CoreRuntime");
                string sInstall = (@"D:/Program Files (x86)/ArcGIS/Desktop10.2");
                //@"D:/Program Files (x86)/ArcGIS/Desktop10.2/Styles/
