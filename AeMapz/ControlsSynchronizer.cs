    ...
    public class ControlsSynchronizer
    {
        ...
        public void ActivateMap()
        {
            try
            {
                ...
                //将之前MapControl最后使用的tool作为活动的tool赋给MapControl的CurrentTool
        ...
        public void ActivatePageLayout()
        {
            try
            {
                ...
                //为每一个的framework control，设置Buddy control为PageLayoutControl
        ...
        public void ReplaceMap(IMap newMap)
        {
            ...
            //create a new instance of IMaps collection which is nedded by the PageLayout
            ...
            //we must call ActivatePageLayout, since it is the control wei call 'ReplaceMaps'
        ...
        /// <param name="mapControl"></param>
        /// <param name="pageLayoutControl"></param>
        /// <param name="activateMapFirst">true if the MapControl supposed to be activatedfirst,如果 MapControl 被首先激活,则为 true</param>
        public void BindControls(IMapControl3 mapControl, IPageLayout2 pageLayoutControl, bool activateMapFirst)
        {
            if (mapControl == null || pageLayoutControl == null)
                throw new Exception("ControlsSynchronizer::BindControls:\r\nEither MapControl or PageLayoutControl are not initialized!");
            m_mapControl = MapControl;
            m_pageLayoutControl = PageLayoutControl;//文档里是pageLayoutControl
        ...
        public void BindControls(bool activateMapFirst)
        {
            ...
            //make sure the last active control is activated
            //确定最后活动的control被激活
            if (activateMapFirst)
                this.ActivateMap();
            else
        ...
        /// <summary>
        ///by passing the application's toolbars and TOC to the synchronization class, it savesyou the
        ///management of the buddy control each time the active control changes. This method ads the framework
        ///control to an array; once the active control changes, the class iterates through thearray and
